...
Request URL: ``http://mytorrentserver/rundb/api/mesh/v1/compositeexperiment/?format=json&limit=1``
...
.. code-block:: python
	...
	ts_api_request = requests.get("http://mytorrentserver/rundb/api/mesh/v1/compositeexperiment/", params={"format": "json", "limit": 1})
