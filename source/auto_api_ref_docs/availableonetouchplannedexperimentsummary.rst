Availableonetouchplannedexperimentsummary Resource
==========================================================================
...
.. include:: ../manual_api_ref_docs/availableonetouchplannedexperimentsummary.rst
...
Request URL: ``http://mytorrentserver/rundb/api/v1/availableonetouchplannedexperimentsummary/?format=json&limit=1``
...
.. code-block:: python
	...
	ts_api_request = requests.get("http://mytorrentserver/rundb/api/v1/availableonetouchplannedexperimentsummary/", params={"format": "json", "limit": 1})
	    ...
	    "objects": [
	        {
	            ...
	            "cycles": null, 
	            "resource_uri": "/rundb/api/v1/availableonetouchplannedexperimentsummary/104224/"
	        }
	    ]
	}
