Availableplannedexperimentsummary Resource
==========================================================================
...
.. include:: ../manual_api_ref_docs/availableplannedexperimentsummary.rst
...
Request URL: ``http://mytorrentserver/rundb/api/v1/availableplannedexperimentsummary/?format=json&limit=1``
...
.. code-block:: python
	...
	ts_api_request = requests.get("http://mytorrentserver/rundb/api/v1/availableplannedexperimentsummary/", params={"format": "json", "limit": 1})
	ts_api_response = ts_api_request.json()
	
	availableplannedexperimentsummarys = ts_api_response["objects"]
	
	for availableplannedexperimentsummary in availableplannedexperimentsummarys:
	    print availableplannedexperimentsummary
	    ...
	    "objects": [
	        {
	            ...
	            "cycles": null, 
	            "resource_uri": "/rundb/api/v1/availableplannedexperimentsummary/111207/"
	        }
	    ]
	}
