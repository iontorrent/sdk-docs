Availableionchefplannedexperimentsummary Resource
==========================================================================
...
.. include:: ../manual_api_ref_docs/availableionchefplannedexperimentsummary.rst
...
Request URL: ``http://mytorrentserver/rundb/api/v1/availableionchefplannedexperimentsummary/?format=json&limit=1``
...
.. code-block:: python
	...
	ts_api_request = requests.get("http://mytorrentserver/rundb/api/v1/availableionchefplannedexperimentsummary/", params={"format": "json", "limit": 1})
	ts_api_response = ts_api_request.json()
	
	availableionchefplannedexperimentsummarys = ts_api_response["objects"]
	
	for availableionchefplannedexperimentsummary in availableionchefplannedexperimentsummarys:
	    print availableionchefplannedexperimentsummary
...
.. code-block:: javascript

	{
	    ...
	    "objects": [
	        {
	            "isReverseRun": false, 
	            "planDisplayedName": "140311_Ion Chef GUI AmpliSeq Exome", 
	            "storage_options": "A", 
	            "preAnalysis": true, 
	            ...
	            "date": "2014-03-11T22:55:18.000737+00:00", 
	            "isSystem": false, 
	            "libkit": null, 
	            "planName": "140311_Ion_Chef_GUI_AmpliSeq_Exome", 
	            "chefMessage": "", 
	            ...
	            "runname": null, 
	            "usePreBeadfind": true, 
	            "planGUID": "a6b76a9c-3d85-4bc0-937a-2558434d5669", 
	            "cycles": null, 
	            "resource_uri": "/rundb/api/v1/availableionchefplannedexperimentsummary/103204/"
	        }
	    ]
	}
