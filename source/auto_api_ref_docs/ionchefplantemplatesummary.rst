Ionchefplantemplatesummary Resource
==========================================================================
...
.. include:: ../manual_api_ref_docs/ionchefplantemplatesummary.rst
...
Request URL: ``http://mytorrentserver/rundb/api/v1/ionchefplantemplatesummary/?format=json&limit=1``
...
.. code-block:: python
	...
	ts_api_request = requests.get("http://mytorrentserver/rundb/api/v1/ionchefplantemplatesummary/", params={"format": "json", "limit": 1})
	    ...
	    "objects": [
	        {
	            ...
	            "cycles": null, 
	            "resource_uri": "/rundb/api/v1/ionchefplantemplatesummary/111154/"
	        }
	    ]
	}
